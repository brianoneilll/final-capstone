              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="clients.php" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-dollar-sign">
                                    ...
                                    <!--/.bg-holder-->
                                        <div class="position-relative z-index-2">
                                            <div>
                                                ...
                                                <?php $name = 'Elthon'; echo $name;?>, your current balance is

                                                </h3>
                                            </div>
                                            <div class="d-flex py-3">
                                                <div class="ps-3">
                                                    <h2 class="text-800 mb-0">₱21,349.29 </h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
